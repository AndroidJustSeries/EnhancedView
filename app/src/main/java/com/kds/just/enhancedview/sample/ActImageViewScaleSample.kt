...
class ActImageViewScaleSample : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.selectImage0).setOnClickListener(this)
        findViewById<View>(R.id.selectImage1).setOnClickListener(this)
        findViewById<View>(R.id.selectImage2).setOnClickListener(this)
...
//    app:imgUrl="https://upload.wikimedia.org/wikipedia/ko/c/cf/%EA%B7%B9%ED%95%9C%EC%A7%81%EC%97%85_%ED%8F%AC%EC%8A%A4%ED%84%B0.jpg"
    ...
    override fun onClick(v: View) {
        ...
        } else if (id == R.id.selectImage0) {
            (v as EnhancedImageView).setGroupSelected(true)
        } else if (id == R.id.selectImage1) {
            (v as EnhancedImageView).setGroupSelected(true)
        } else if (id == R.id.selectImage2) {
            (v as EnhancedImageView).setGroupSelected(true)
        }
    }
}