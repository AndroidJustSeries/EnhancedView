...
open class EnhancedCheckBox : AppCompatCheckBox, EnhancedControl {
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        ...
        mDrawableHelper.mBGColorNormal =
            ta.getColor(R.styleable.EnhancedView_BgColorNormal, mDrawableHelper.mBGColorNormal)
        mDrawableHelper.mBGColorSelected =
            ta.getColor(R.styleable.EnhancedView_BgColorSelected, mDrawableHelper.mBGColorSelected)
    ...
    override fun setTextColor(normal: Int, selected: Int) {
        ...
        val textColor = mDrawableHelper.getTextColor(android.R.attr.state_checked)
    ...
    override fun onDraw(canvas: Canvas) {
        if (background == null) {
            mDrawableHelper.drawBg(canvas, width, height, isPressed, isChecked)
        }
        super.onDraw(canvas)
    }
